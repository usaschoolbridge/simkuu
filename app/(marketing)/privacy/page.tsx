  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Third-Party Services", content: "We share data with trusted service providers including Stripe (payments), Resend (email), Upstash (rate limiting), and Cloudflare (CDN/security). All processors are GDPR-compliant." },
